...
class TimeSeriesAnalyzer:
    ...
    def calculate_changes(self):
        ...
        changes["total"] = {
            ...
            "percentage": round(float((end_val - start_val) / start_val * 100), 2) if start_val != 0 else "N/A",
        ...
        summary = {
            ...
            "trend_analysis": {
                ...
                "total_change": {
                    ...
                    "percentage": round(changes["total"]["percentage"], 2) if isinstance(changes["total"]["percentage"], float) else 'N/A',
