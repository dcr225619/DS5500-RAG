...
with open(os.path.join(base_dir, "../src/output.json"), "r", encoding="utf-8") as f:
...
def main():
    ...
    for idx, series in enumerate(series_list):
        ...
        try:
            ...
            with open(os.path.join(base_dir, "../src/output_with_descriptions.json"), "w", encoding="utf-8") as f:
