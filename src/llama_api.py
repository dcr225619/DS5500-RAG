...
with open(os.path.join(base_dir, "../files/indicator_guide_compact.txt"), encoding="utf-8") as f:
        ...
        for idx, result in enumerate(api_results):
            ...
            if idx == len(api_results) - 1:
                ...
                tool_result["reminder"] = (
                    ...
                    f"Also be sure to note the units of the indicators in the summary."
                )
...
if __name__ == "__main__":
    ...
    filepath = "../files/llama3.2/QA_test_llama_api_finetuned6.json"
